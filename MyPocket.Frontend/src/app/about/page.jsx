...
function About() {
  return (
    <div className={styles.text}>
      {`Welcome to MyPocket, a user-friendly web application designed to help you manage your finances in a
        ...
        and helps you achieve your financial goals. At MyPocket, we value transparency, security, and user privacy.
        ...
        affordable premium plans with advanced functionalities. Thank you for choosing MyPocket as your financial
