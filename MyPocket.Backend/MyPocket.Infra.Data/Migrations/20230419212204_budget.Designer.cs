...
namespace MyPocket.Infra.Data.Migrations
{
    ...
    [Migration("20230419212204_budget")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPocket.Domain.Models.BudgetItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyPocket.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyPocket.Domain.Models.BudgetItem", b =>
                {
                    b.HasOne("MyPocket.Domain.Models.Budget", "Budget")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("MyPocket.Domain.Models.Transaction", b =>
                {
                    b.HasOne("MyPocket.Domain.Models.Account", "Account")
